...
func NewInstrumentingService(
	counter metrics.Counter, latency metrics.Histogram, s transaction.Service,
) transaction.Service {
...
func (s *instrumentingService) LoadAll(ctx context.Context) []transaction.Transaction {
	defer func(begin time.Time) {
